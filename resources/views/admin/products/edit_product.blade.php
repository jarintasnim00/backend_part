             ...
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/edit-product/'.$productDetails->id)}}" method="post"> {{csrf_field()}}
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" class="form-control" value="{{$productDetails->title}}"  name="title" id="title" required>
                      </div>
                      ...
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control" value="{{$productDetails->price}}" name="price" id="price" required>
                      </div>
                      <div class="form-group">
